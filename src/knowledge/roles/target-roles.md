...
- API or SDK engineering
- product engineering
- conversational interfaces

Preferred shape:

- clear-scope individual contributor roles
- thoughtful, AI-native engineering cultures
- teams that build genuinely useful products
- open-source-friendly environments are a plus
